...
- Bumped runtime dependency floors to versions that support NumPy 2: `rasterio>=1.3.11`, `shapely>=2.1.0`

### Removed

- Support for Python 3.8 and 3.9; minimum supported version is now Python 3.10
...
- Changed default behavior in mask and footprint creation to not include holes ([#26](https://github.com/pjhartzell/raster-footprint/pull/26))
